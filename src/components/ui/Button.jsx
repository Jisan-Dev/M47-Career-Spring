...
const Button = ({ text, px, py, clickHandler, width }) => {
  return (
    <button
      onClick={clickHandler && clickHandler}
      className={`relative inline-flex items-center justify-center ${px ? px : 'px-5'} ${
        py ? py : 'py-3'
      } overflow-hidden font-medium transition duration-300 ease-out rounded-lg shadow-xl group hover:ring-1 hover:ring-[#9873FF] cursor-pointer ${width && width}`}>
